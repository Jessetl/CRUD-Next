      ...
      if (!!!isSubmitted) {
        ...
        await fetch(`${API_URL}/todos/${id}`, {
          ...
          .then(async (res) => {
            ...
            let copyPosts = [...storePosts];
            const keyPost = storePosts.findIndex(({ id }) => id === post.id);
            const findPost = storePosts.find(({ id }) => id === post.id);
            ...
            if (!!findPost) {
              ...
              dispatch({ type: "Post/SET", post: copyPosts });
  ...
  return (
    <div className="row justify-content-center">
      <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <PageTitle backUrl="/">EDICIÓN DE POST</PageTitle>
      </div>
...
PostEdit.getInitialProps = async ({ query: { id } }) => {
  ...
  return { id, post, users };
};

PostEdit.Layout = HomeLayout;
